        ...
        {hasPremiumPlan ? (
          <>
            <DialogHeader>
              ...
              <DialogDescription>
                ...
                para gerar um relatório com{" "}
                <span className="text-primary">insights</span> sobre suas
                finanças.
              </DialogDescription>
            </DialogHeader>
          ...
          <>
            <DialogHeader>
              ...
              <DialogDescription>
                Você precisa de um{" "}
                <span className="text-primary">Plano Premium</span> para gerar
                um relatório com <span className="text-primary">IA</span>.
              </DialogDescription>
            </DialogHeader>
            <DialogFooter>
              <DialogClose asChild>
